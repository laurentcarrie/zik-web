...
STACK_NAME="zik-web-prod-fargate"
PROFILE="${AWS_PROFILE:?Set AWS_PROFILE env var}"
TEMPLATE="cloudformation-prod-fargate.yml"
...
# ECR image URI
ECR_IMAGE_URI="${ECR_IMAGE_URI:-579871531410.dkr.ecr.eu-west-3.amazonaws.com/zik-web:latest}"
